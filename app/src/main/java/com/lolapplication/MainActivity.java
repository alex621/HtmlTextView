...
public class MainActivity extends AppCompatActivity {
    ...
    public static class MyAdapter extends HtmlTextView.HtmlTextViewAdapter{
        @Override
        public HtmlTextView.ImgViewHolder renderImg(Context context, String src, HtmlTextView.ImgViewHolder oldViewHolder) {
            if (oldViewHolder == null){
                View v = new View(context);
                v.setBackgroundColor(0x330000FF);
                oldViewHolder = new HtmlTextView.ImgViewHolder(v);
            }

            Log.d(TAG, "render img: " + src);
